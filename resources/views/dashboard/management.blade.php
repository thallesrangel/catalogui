...
@section('content')
    ...
    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever=""><i class="bi bi-plus-square"></i> Adicionar publicação</button>
            ...
            @foreach($posts as $item)
                <div class="card col-md-4 card-announcement">
                    ...
                    <ul class="list-inline ">
                        ...
                        <li class="list-inline-item"><a href="">Inativar</a></li>
                    </ul>
                </div>
            @endforeach
        </div>
    ...
    <div class="container">
        ...
        <h5>Cupons de Descontos</h5>

        <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalCoupon" data-bs-whatever=""><i class="bi bi-plus-square"></i> Adicionar publicação</button>
