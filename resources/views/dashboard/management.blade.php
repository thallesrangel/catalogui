...
@section('content')
    ...
    <br>
        ...
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalCoupon" data-bs-whatever=""><i class="bi bi-plus-square"></i> Adicionar publicação</button>
